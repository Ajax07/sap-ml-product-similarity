...
from app.services.preprocessing import ProductPreprocessor
...
EMBEDDINGS_PATH = CACHE_DIR / "text_embeddings.npy"
...
structured_features = builder.build_structured_features(processed_df)
...
if EMBEDDINGS_PATH.exists():
    ...
    text_embeddings = encoder.encode(processed_df["combined_text"].tolist())
...
final_embeddings = np.hstack(
    [structured_features * structured_weight, text_embeddings * text_weight]
)

similarity_engine = SimilarityEngine(processed_df, final_embeddings)
